...
$.ajax({
 ...
 success: function(data){
    ...
    for(var i = 0; i < data_length; i++){
        ...
        $(`#message-text${i}`).append($(`<button id="message-opt${i}"><span class="material-icons" id="iconDelete">delete</span></button>`))
        $(`#message-opt${i}`).append($(`<button id="message-opt${i}"><span class="material-icons" id="iconEdit">create</span></button>`))
    }
}})
$(function () {
